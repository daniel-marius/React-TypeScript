...
export const TOGGLE_TODO = "TOGGLE_TODOO";
...
export const addTodo = (): ActionsType => ({ type: ADD_TODO });

export const deleteTodo = (id: number): ActionsType => ({
  type: DELETE_TODO,
  payload: id
});

export const updateTodo = (id: number, text: string): ActionsType => ({
  type: UPDATE_TODO,
  payload: {
    id,
    text
...
export const setNewTodo = (text: string): ActionsType => ({
  type: SET_NEWTODO,
  payload: text
});

export const setTodos = (todos: Todo[]): ActionsType => ({
  type: SET_TODOS,
  payload: todos
});
