...
import { IPokemon } from "../custom-hooks/usePokemon";
...
const PillButton: React.FunctionComponent<React.DetailedHTMLProps<
...
export const PokemonCard: React.FunctionComponent<IPokemon & {
  selected: boolean;
